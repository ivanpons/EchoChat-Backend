...
import com.llimapons.echo.domain.events.chat.ChatEventConstants
import com.llimapons.echo.domain.events.user.UserEventConstants
...
class RabbitMqConfig {
    ...
    fun messageConverter(): JacksonJsonMessageConverter {
        val polymorphicTypeValidator = BasicPolymorphicTypeValidator.builder()
            .allowIfBaseType(EchoEvent::class.java)
